...
def main():
    ...
    parser.add_argument('--scan_path', default='', help='path to scannet scene (e.g., data/ScanNet/v2/scene0000_00')
    parser.add_argument('--output_file', default='', help='output file')
    parser.add_argument('--label_map_file', default='', help='path to scannetv2-labels.combined.tsv')
